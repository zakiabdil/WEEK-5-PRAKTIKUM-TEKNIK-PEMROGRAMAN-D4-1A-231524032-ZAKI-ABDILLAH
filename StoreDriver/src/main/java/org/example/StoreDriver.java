...
public class StoreDriver {
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        while (sc.hasNext()) {
            ...
            }else if(employeeType.equals("Janitor")){
                Janitor janitor = new Janitor(numberOfHoursWorked, hourlyRate, storeDetails, empName);
        ...
        System.out.println("******************************************************");
        System.out.println("Number of employees working as Janitor are: " + JanitorList.size());
        System.out.println("******************************************************");
        pwd.println("******************************************************");
        pwd.println("Number of employees working as Janitor are: " + JanitorList.size());
        pwd.println("******************************************************");
        ...
        for (Janitor janitor : JanitorList) {
            janitorCount++;
            System.out.println(janitorCount + ". Janitor Details:");
            System.out.println(janitor);
            pwd.println(janitor);
            System.out.println("Gross Payment: $" + janitor.calculatePay());
            pwd.println("Gross Payment: $" + janitor.calculatePay());
        }
        pwd.close();
